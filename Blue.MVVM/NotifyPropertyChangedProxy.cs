...
namespace Blue.MVVM {
    ...
    /// </summary>
  public class NotifyPropertyChangedProxy : NotifyPropertyChangedCore {
        ...
        public NotifyPropertyChangedProxy(INotifyPropertyChanged sender, Func<PropertyChangedEventHandler> handlerProvider) : base (sender) {
            if (sender == null)
